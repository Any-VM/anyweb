...
export default function TopBar() {
	...
	const pageSelectEffect = (path: string) => {
		const baseClass = 'flex size-10 flex-col transition-all ';
	...
	const handleClick = (
		path: string | ((prevState: string) => string) | Partial<Path>
	) => {
					...
					<>
						<Dialog>
							...
							<DialogContent>
								<DialogHeader>
									<DialogTitle>
										Git Links and Other Info
									</DialogTitle>
									<DialogDescription>
										Links to AnyVM github, the project repo,
										contributors, and other hosting
										instructions
									</DialogDescription>
									<hr />
									<div className="flex">
